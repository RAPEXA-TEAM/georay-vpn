...
import com.example.cross_vpn.v2ray.util.MyContextWrapper
...
//        saveVpnNetworkInfo(configName, info)
        ...
        this.applicationContext.getSharedPreferences("STAT", Context.MODE_PRIVATE).edit().putBoolean("start", false).apply()
    }
