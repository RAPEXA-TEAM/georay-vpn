...
public class KeepAlive extends BroadcastReceiver {
	...
	public static final String ACTION_KEEPALIVE_ALARM = "com.example.cross_vpn.openconnect.KEEPALIVE_ALARM";
	...
	private void scheduleNext(Context context, int delayMs) {
		Intent intent = new Intent("com.example.cross_vpn.openconnect.KEEPALIVE_ALARM");
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			mPendingIntent = PendingIntent.getActivity(context, 0, intent, PendingIntent.FLAG_IMMUTABLE);
		}else{
