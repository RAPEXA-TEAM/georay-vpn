...
public class Xposed implements IXposedHookZygoteInit {
	...
	public static final String PKG_NAME = "com.example.cross_vpn.openconnect";
		...
		XposedHelpers.findAndHookMethod(className, null, "prepare",
			...
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
				...
				if (PKG_NAME.equals(a[0]) && a[1] == null) {
					// Normally ConfirmDialog calls prepare("com.example.cross_vpn.openconnect", null) to see whether
