...
import com.example.cross_vpn.openconnect.api.IOpenVPNAPIService;
import com.example.cross_vpn.openconnect.api.IOpenVPNStatusCallback;
import com.example.cross_vpn.openconnect.VpnProfile;
import com.example.cross_vpn.openconnect.core.OpenVPN.ConnectionStatus;
import com.example.cross_vpn.openconnect.core.OpenVpnService;
import com.example.cross_vpn.openconnect.core.OpenVpnService.LocalBinder;
...
public class ExternalOpenVPNService extends Service {
	...
	private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
		...
		public void startProfile(String profileUUID) throws RemoteException {
			...
			shortVPNIntent.setClass(getBaseContext(),com.example.cross_vpn.openconnect.LaunchVPN.class);
			shortVPNIntent.putExtra(com.example.cross_vpn.openconnect.LaunchVPN.EXTRA_KEY,profileUUID);
